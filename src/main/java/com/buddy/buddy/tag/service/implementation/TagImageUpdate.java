...
import com.buddy.buddy.exception.TagOperationException;
...
public class TagImageUpdate {
    ...
    public void updateTagImages() {
        ...
        } catch (TagOperationException tagOperationException) {
            throw new TagOperationException("Not enough records " +  tagOperationException.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
